<!-- clank-right
# This file is generated by `clank-right` (in ~/code/system/clank-right) from its template
# templates/AGENTS.md.vto. Don't edit the generated sections here: change the
# options below or the template, then run `clank-right update .` in this repo.
