...
async function main(): Promise<void> {
	...
	const page  = await render_chart_page({
		...
		subtitle_html: "What the linux-x64 `claude` binary is made of, stacked: the Bun/JavaScriptCore runtime, precompiled JSC bytecode, the minified JS bundle, native addons, and vendored assets. JSC bytecode is ~8&times; the size of the JS it is compiled from.",
